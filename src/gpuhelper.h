...
class GpuHelper
{
  public:
    ...
    */
    ...
    inline void draw(GLenum mode, unsigned int start, unsigned int end);

    /// draw an indexed subset
    inline void draw(GLenum mode, const std::vector<unsigned int>* pIndexes);
...
inline void GpuHelper::draw(GLenum mode, unsigned int nofElement)
{
    glDrawArrays(mode, 0, nofElement);
}


inline void GpuHelper::draw(GLenum mode, const std::vector<unsigned int>* pIndexes)
{
    glDrawElements(mode, pIndexes->size(), GL_UNSIGNED_INT, &(pIndexes->front()));
}

inline void GpuHelper::draw(GLenum mode, unsigned int start, unsigned int end)
{
